...
export default function PriceCalculatorModal({ product, onClose, onCalculate }) {
  ...
  const { addItem, createCartItem } = useCart();
  ...
  const getPersonalizacionesDetalladas = () => {
  ...
  const handleAddToCart = () => {
    ...
    try {
      ...
      const personalizaciones = getPersonalizacionesDetalladas();
      const precioFinal = calculatedPrice?.precioFinal || calculatedPrice || getEstimatedPrice();

      const cartItem = createCartItem({
        producto: product,
        variante: selectedVarianteObj,
        cantidad,
        personalizaciones,
        notas,
            ...
            <Card>
              <CardContent>
                <FormControl component="fieldset" fullWidth>
                  ...
                  <RadioGroup value={selectedVariante} onChange={handleVarianteChange}>
                      ...
                      <FormGroup>
                        {atributo.opciones.map((opcion) => (
                          <FormControlLabel
                            ...
                            label={
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                                <Typography variant="body1">{opcion.nombre}</Typography>
                                <Typography 
                                  variant="body2" 
            ...
            <Card sx={{ bgcolor: 'primary.light', color: 'primary.contrastText' }}>
              <CardContent>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                  <Typography variant="h6">Precio estimado total:</Typography>
